 ...
 * Meta Pixel `Lead`/`Contact` are fired on the /thank-you bridge page (where
 * GHL redirects after a successful submission), NOT here — this keeps the form
 * embed clean and ensures Lead is counted exactly once.
 */
